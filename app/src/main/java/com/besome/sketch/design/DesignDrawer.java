...
public class DesignDrawer extends LinearLayout {
    ...
    private final View.OnClickListener drawerItemClickListener = v -> {
        ...
        } else if (id == R.id.item_files_code_mode) {
            designActivity.toFilesCodeMode();
    ...
    public DesignDrawer(@NonNull Context context, @Nullable AttributeSet attrs) {
        ...
        addDrawerItem(R.id.item_files_code_mode, R.drawable.ic_mtrl_folder_code, R.string.text_title_menu_files, R.string.text_subtitle_menu_files, content);
